    ...
    <table width="700" align="center" border="1">
     ...
     %>
      <tr>
        ...
        <td id="incon"> <div id="content"> <%=mlist.get(i).getContent()%> </div></td>
        <td align="center"> <%=state%> </td>
        <td align="center"> <%=mlist.get(i).getWriteday()%> </td>
        <td align="center"> <a href="delete.jsp?id=<%=mlist.get(i).getId()%>"> click </a> </td>
      </tr>
       <%
         if(mlist.get(i).getState()==1) // 답변이 있을때만 보여주기
         {
       %>
      <tr>
        <td align="center" style="color:red;"> 답변내용 </td>
        <td id="incon"> <div id="content"> <%=mlist.get(i).getAnswer()%> </div></td>
        <td align="center"> </td>
        <td align="center"> </td>
        <td align="center"> </td>
      </tr>
